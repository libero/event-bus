...
export class EventUtils {
    ...
    public static eventToMessage<T extends object>(event: Event<T>): MessageWrapper<Event<T>> {
    ...
    public static messageToEvent<T extends object>(message: MessageWrapper<Event<T>>): Option<Event<T>> {
